...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which fruit is red? <br> A: Apple <br> B: Orange <br> C: Banana</html>");
		question3 = new JLabel("<html>Which fruit is green outside and red inside? <br> A: Watermelon <br> B: Mango <br> C: Cantaloupe</html>");
		question4 = new JLabel("<html>Which fruit is not a sphere? <br> A: Orange <br> B: Banana <br> C: Dragonfruit</html>");
	}
	@Override
